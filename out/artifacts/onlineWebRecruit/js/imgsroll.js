...
imgs[1].src = "images/header1.jpg";
imgs[2].src = "images/header2.jpg";
imgs[3].src = "images/header3.jpg";
imgs[4].src = "images/header4.jpg";
imgs[5].src = "images/header5.jpg";
var imgwidth = 549;//图片宽度
var imgheight = 192;//图片高度

//============================= edit by gaoxy =================================================
var PicNum = 5; //设置图片个数,要与上方定义的确良连接组与图片组相同,并且要大于等于1
var ScollTimes = 5000;//图片自动更换时间，单位为毫秒
